...
div.tools a {
  color: <?php echo $GLOBALS['cfg']['AccentColor'] ?>!important
}
...
.coldrop {
  width: 24px;
  height: 24px;
  -webkit-mask-image: url(<?php echo $theme->getImgPath('svg/chevron-down.svg');
  ?>);
  mask-image: url(<?php echo $theme->getImgPath('svg/chevron-down.svg');
  ?>);
  cursor: pointer;
  margin: 12px 0;
  position: absolute;
...
#pma_console .toolbar {
  position: relative;
  background: <?php echo $GLOBALS['cfg']['BackgroundCard'] ?>;
  border: none;
  cursor: n-resize;
  box-shadow: <?php echo $GLOBALS['cfg']['Shadow'] ?>
}
...
#pma_console .content.console_dark_theme .CodeMirror-cursor {
  border-color: <?php echo $GLOBALS['cfg']['WhiteColor'] ?>
}
